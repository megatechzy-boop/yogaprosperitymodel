...
<head>
  ...
  <link rel="icon" type="image/png" sizes="512x512" href="/assets/images/yoga-prosperity-model-logo.png">
  <link rel="apple-touch-icon" href="/assets/images/yoga-prosperity-model-logo.png">
...
<body>
  ...
  <header class="site-header">
    <a class="brand" href="/" aria-label="Yoga Prosperity Model home">
      <img class="brand-logo" src="/assets/images/yoga-prosperity-model-logo.png" alt="" width="512" height="512">
    ...
    <nav id="primary-nav" aria-label="Main navigation">
      ...
      <a class="<?= $current === 'method' ? 'active' : '' ?>" href="/yoga-prosperity-method.php">Our Method</a>
      <a class="<?= $current === 'programs' ? 'active' : '' ?>" href="/programs.php">Programs</a>
      <a class="<?= $current === 'about' ? 'active' : '' ?>" href="/about.php">About</a>
      <a class="<?= $current === 'blog' ? 'active' : '' ?>" href="/blog.php">Resources</a>
    </nav>
